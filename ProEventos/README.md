...
# Seja Full-Stack com .NET Web API e Angular + EF Core - V2.0 - [Course](http://www.udemy.com/course/).
...
If you want to see this link course, really in action [original site](https://www.j.com).

## Basic Setup

1. [Install Node.js](https://nodejs.org/)
1. [Install .NET Core 5](https://dotnet.microsoft.com/download/)
2. Fork the [ProEventos](https://github.com/j)
...
```
# Site settings
title: J - Professor and Full-stack Developer
...
Having a problem getting something to work or want to know why I setup something in a certain way? Ping me on Twitter [@j](https://twitter.com/j) or Message on [Facebook](http://facebook.com/j)


## Donation

If you liked my work, [subscribe on youtube](https://www.youtube.com/user/j)
Or buy the course using [this link](http://www.udemy.com/course/).
...
If you’d like to give me credit somewhere on your blog or tweet a shout out to [@j](https://twitter.com/j), that would be pretty sweet.
